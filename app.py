...
def cadastrar_adm():
    ...
    sql = "INSERT INTO adm (NOME_ADM, CPF_ADM , EMAIL_ADM,  TELEFONE_ADM, CARGO_ADM, SETOR_ADM) VALUES (%s, %s, %s, %s, %s, %s)"
...
def cadastrar_fun():
    ...
    sql = "INSERT INTO funcionarios (NOME_FUN, CPF_FUN , EMAIL_FUN,  TELEFONE_FUN, CARGO_FUN, SETOR_FUN) VALUES (%s, %s, %s, %s, %s, %s)"
...
def cadastrar_trein():
    ...
    trein = Treinamentos(dados['nome'], dados['validade'])
    ...
    cursor.execute(sql, (trein.nome_nr, trein.validade_dias))
...
def cadastrar_rel():
    ...
    rel = Relatorio(dados['data_realizacao'], dados['data_vencimento'])

    conn = get_db_connection()
    cursor = conn.cursor()

    sql = "INSERT INTO funcionarios (DATA_REALIZACAO, DATA_VENCIMENTO) VALUES (%s, %s)"

    cursor.execute(sql, (rel.data_realizacao, rel.data_vencimento ))
